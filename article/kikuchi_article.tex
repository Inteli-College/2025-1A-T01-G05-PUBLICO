...
\subsection{Robot Testing}
After all the calibration and mapping, the primary tests occurred using equipment from Inteli's Maker Laboratory, which is filled with a range of equipment, ranging from cheap sensors and microcontrollers to fully commercial robots.
...
For a rapid comparison, we tested the accuracy of generating a map using a Dell G3 15 and the lab's high-performance computer, which has extremely high specifications compared to the first PC. The computer specifications can be checked in Table~\ref{tab:hardware_comparison}.
...
\begin{tabular}{ |p{3cm}||p{3cm}|p{3cm}|  }
 \hline
 \multicolumn{3}{|c|}{Hardware Comparison} \\
 \hline
 \textbf{Component} & \textbf{Dell G3} & \textbf{Lab Computer}\\
 \hline
...
The results from the first mapping tests are detailed in Table~\ref{tab:test_results}.

\begin{table}[ht]
\centering
\caption{Results for the First Tests}
\label{tab:test_results}
\begin{tabular}{ |p{4.5cm}||p{3cm}|p{3cm}|  }
 \hline
 \multicolumn{3}{|c|}{Results} \\
 \hline
 \textbf{Item} & \textbf{Dell G3} & \textbf{Lab Computer}\\
 \hline
